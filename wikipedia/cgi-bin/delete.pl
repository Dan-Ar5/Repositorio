...
<html>
  <head>
    <meta charset="utf-8">
    <title>Las paginas eliminadas</title>
  </head>
  <body>
HTML
...
print <<HTML;
    <h1 class="title-delete">La pagina fue eliminada correctamente</h1>
    <h2 class="link-list"><a href="list.pl">volver a : mis paginas</a></h2>
  </body>
</html>
HTML
